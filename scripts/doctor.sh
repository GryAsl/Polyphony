...
for b in agy-delegate agy-job agy-cost-compare agy-doctor cloud-debug agy-trace measure-session agy-media agy-review agy-scout agy-quota agy-account agy-routing polyphony-agent; do
